...
@NullableGeoPointConverter() GeoPoint? get driverLocation;@NullableTimestampConverter() DateTime? get driverLocationUpdatedAt;@TimestampConverter() DateTime get createdAt;@TimestampConverter() DateTime get updatedAt;@NullableTimestampConverter() DateTime? get pickedUpAt;@NullableTimestampConverter() DateTime? get deliveredAt;@NullableTimestampConverter() DateTime? get estimatedDeliveryTime;@GeoPointListConverter() List<GeoPoint> get polylinePoints;
...
as double,driverLocation: freezed == driverLocation ? _self.driverLocation : driverLocation // ignore: cast_nullable_to_non_nullable
as GeoPoint?,driverLocationUpdatedAt: freezed == driverLocationUpdatedAt ? _self.driverLocationUpdatedAt : driverLocationUpdatedAt // ignore: cast_nullable_to_non_nullable
...
/// keep one user from reading another's profile, so it cannot come from
/// the driver's user document.
@override@NullableGeoPointConverter() final  GeoPoint? driverLocation;
@override@NullableTimestampConverter() final  DateTime? driverLocationUpdatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,driverId,status,pickupAddress,pickupGeoPoint,dropoffAddress,dropoffGeoPoint,packageDescription,packageWeight,packageCategory,recipientName,recipientPhone,estimatedDistanceKm,estimatedDurationMin,baseFare,surgeMultiplier,totalFare,paymentMethod,paymentStatus,paystackReference,promoCode,discountAmount,trackingCode,notes,proofOfDeliveryUrl,rating,ratingComment,driverEarnings,platformCommission,driverLocation,driverLocationUpdatedAt,createdAt,updatedAt,pickedUpAt,deliveredAt,estimatedDeliveryTime,const DeepCollectionEquality().hash(_polylinePoints)]);
